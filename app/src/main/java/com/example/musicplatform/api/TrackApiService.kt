...
import com.example.musicplatform.tracks.ServerTrack
...
interface TrackApiService {
    ...
    @POST("/tracks/upload")
    @Multipart
    fun uploadFile(@Part userId: Long, @Part file: MultipartBody.Part): Call<Track>
    ...
    fun deleteTrack(@Path("trackId") trackId: Long): Call<String>
    ...
    fun downloadAndSaveFile(@Query("path") path: String, @Query("fileName") fileName: String): Call<ResponseBody>

    @GET("/tracks/download")
    fun downloadFileAndSave(@Query("fileName") fileName: String, @Query("path") path: String): Call<String>
